...
public interface IUserRepository : IRepository<User>
{
    ...
    /// <summary>
    /// Finds a credential-login account by its username, or null when none matches. Used by the
    /// admin/realtor/super-admin login (credentials live entirely in the database).
    /// </summary>

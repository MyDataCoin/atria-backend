...
string[] throttledPaths =
{
    ...
    // Проверка «занят ли номер» до отправки кода. Отвечает без всякой аутентификации, поэтому лимит
    // здесь — единственное, что стоит между перебором номеров и списком наших инвесторов.
